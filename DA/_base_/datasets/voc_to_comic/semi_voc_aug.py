...
sup_aug_pipeline = [
    ...
    dict(type='AlbuDomainAdaption', domain_adaption_type='ALL',
         target_dir='data/comic/JPEGImages', p=0.5),
...
unlabeled_dataset = dict(
    ...
    data_root=data_root,
    metainfo=dict(classes=classes),
    ann_file='comic/train.json',
    data_prefix=dict(img='comic/JPEGImages/'),
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'comic/test.json',
    metric='bbox',
    format_only=False)
